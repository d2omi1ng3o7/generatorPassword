...
""" 
    Moduł - generator haseł. Użytkownik podaje długość hasła a program wzraca wylosowane hasło.
...
while True:
    try:
        ...
        if length < 4 or length > 64:
            os.system('clear') # działa tylko na linuxie j*bać windowsa
            continue
    except ValueError:
        os.system('clear') # działa tylko na linuxie j*bać windowsa
        continue
